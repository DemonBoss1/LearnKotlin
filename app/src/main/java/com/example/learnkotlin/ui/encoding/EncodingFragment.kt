  ...
  override fun onCreateView(
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.button.setOnClickListener {
            val user1privateKey: Int = binding.user1privateKey.text.toString().toInt()
            val user2privateKey: Int = binding.user2privateKey.text.toString().toInt()
            ...
            if (sharedSecret1 == sharedSecret2) binding.sharedSecret.text =
                sharedSecret1.toString();
            else binding.sharedSecret.text = "ERROR"
        }
    }
